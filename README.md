...
won't upgrade the addon automatically when new changes occur.  You'll need to upgrade manually (the addon will show in
your available updates, you'll just need to download it and install from zip). 
